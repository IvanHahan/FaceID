...
from liveness_detection.single_shot.aenet import AENet
...
class LivenessDetector(pl.LightningModule):
    ...
    def setup(self, stage: str):
        from liveness_detection.single_shot.dataset import LivenessDataset
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--network', default='aenet')
